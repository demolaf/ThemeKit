...
struct ChristmasVariant: ThemeVariant {
  ...
  static let classic = ChristmasVariant(
    ...
    light: ChristmasTheme(
      ...
      accent: Color(hex: 0xCC0000), fontName: "Georgia", colorScheme: .light),
    dark: ChristmasTheme(
      backgroundImageName: "bg-classic-dark", iconImageName: "icon-classic",
      accent: Color(hex: 0xFF6B6B), fontName: "Georgia", colorScheme: .dark)
  )
  ...
  static let winter = ChristmasVariant(
    ...
    light: ChristmasTheme(
      ...
      accent: Color(hex: 0x1A5276), fontName: "", colorScheme: .light),
    dark: ChristmasTheme(
      backgroundImageName: "bg-winter-dark", iconImageName: "icon-winter",
      accent: Color(hex: 0x7FD4F4), fontName: "", colorScheme: .dark)
  )
